...
| `src/core/heartbeatTools.ts` | Heartbeat エージェント用ツール定義（listCalendarEvents, getCurrentTime, fetchFeeds, listFeeds, checkMonitors）。HTML パースに linkedom の DOMParser を使用（Worker 環境対応） |
